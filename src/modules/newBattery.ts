import {i_shape, shape1x1, shape1x2, shape2x2, shape2x1, shape01_11, shape10_11, shape11_01, shape11_10} from "./newShapes.js"
import {matrix, sleep, getRandomInt} from "./header.js"
      ...
      for (
        ...
        if (y == 0) {
          for (var x = 0; x < matrix[0].length; x++) {
            if (!matrix[0][x]) {
              s = new shape1x1(x, 0, this.ctx, "red");
            }
          }
        } else {
          for (var x = 0; x < matrix[0].length; x++) {
            ...
            if (mn.length != 0) {
              switch (mn[getRandomInt(mn.length)]) {
                case shape1x1.id: {
                  s = new shape1x1(x, y, this.ctx, "red");
                  break;
                }
                case shape1x2.id: {
                  s = new shape1x2(x, y - 1, this.ctx, "blue");
                  break;
                }
                case shape2x2.id: {
                  s = new shape2x2(x, y - 1, this.ctx, "yellow");
                  break;
                }
                case shape2x1.id: {
                  s = new shape2x1(x, y, this.ctx, "orange");
                  break;
                }
                case shape01_11.id: {
                  s = new shape01_11(x, y - 1, this.ctx, "green");
                  break;
                }
                case shape10_11.id: {
                  s = new shape10_11(x, y - 1, this.ctx, "pink");
                  break;
                }
                case shape11_01.id: {
                  s = new shape11_01(x, y - 1, this.ctx, "cyan");
                  break;
                }
                case shape11_10.id: {
                  s = new shape11_10(x - 1, y - 1, this.ctx, "brown");
                  break;
                }
              }
            }
