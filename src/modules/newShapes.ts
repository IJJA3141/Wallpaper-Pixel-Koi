...
class i_shape{
    ...
    constructor(_x:number, _y:number, _ctx:CanvasRenderingContext2D, _color:string){
        this.x = _x;
        this.y = _y;
        this.ctx = _ctx;
        this.color = _color;
    ...
    public draw():void {};
    public drop():void {};
    public setColor(_color:string):void {this.color = _color; return;};
}
...
export {i_shape, shape1x1, shape1x2, shape2x2, shape2x1, shape01_11, shape10_11, shape11_01, shape11_10}